...
struct FileBrowserView: View, TracedView, SelectorHolder {
    class Selector: SelectorBase {
        @Selected(animation: .default.speed(2), { global.fileBrowser.directories }) var directories
...
private struct ToolbarModifier: ViewModifier, SelectorHolder {
    class Selector: SelectorBase {
        ...
        @Selected(animation: .default, { global.fileBrowser.isSelectingFiles }) var isSelectingFiles
    }
