...
struct Symbolic_Pb_ItemEvent: Sendable {
  ...
  var kinds: [Symbolic_Pb_ItemEvent.Kind] = []
  ...
  struct Kind: Sendable {
    ...
    var kind: Symbolic_Pb_ItemEvent.Kind.OneOf_Kind? = nil
    ...
    var setName: Symbolic_Pb_ItemEvent.SetName {
      get {
        if case .setName(let v)? = kind {return v}
        return Symbolic_Pb_ItemEvent.SetName()
      }
      set {kind = .setName(newValue)}
    }

    var setLocked: Symbolic_Pb_ItemEvent.SetLocked {
      get {
        if case .setLocked(let v)? = kind {return v}
        return Symbolic_Pb_ItemEvent.SetLocked()
      }
    ...
    enum OneOf_Kind: Equatable, Sendable {
      ...
      case setName(Symbolic_Pb_ItemEvent.SetName)
      case setLocked(Symbolic_Pb_ItemEvent.SetLocked)
...
struct Symbolic_Pb_WorldEvent: Sendable {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  var kind: Symbolic_Pb_WorldEvent.OneOf_Kind? = nil

  var setSymbolIds: Symbolic_Pb_WorldEvent.SetSymbolIds {
    get {
      if case .setSymbolIds(let v)? = kind {return v}
      return Symbolic_Pb_WorldEvent.SetSymbolIds()
    }
    set {kind = .setSymbolIds(newValue)}
  }

  var setGrid: Symbolic_Pb_WorldEvent.SetGrid {
    get {
      if case .setGrid(let v)? = kind {return v}
      return Symbolic_Pb_WorldEvent.SetGrid()
    }
    set {kind = .setGrid(newValue)}
  }
  ...
  enum OneOf_Kind: Equatable, Sendable {
    case setSymbolIds(Symbolic_Pb_WorldEvent.SetSymbolIds)
    case setGrid(Symbolic_Pb_WorldEvent.SetGrid)
...
struct Symbolic_Pb_DocumentEvent: @unchecked Sendable {
  ...
  struct Single: Sendable {
    ...
    var worldEvent: Symbolic_Pb_WorldEvent {
      get {
        if case .worldEvent(let v)? = kind {return v}
        return Symbolic_Pb_WorldEvent()
      }
      set {kind = .worldEvent(newValue)}
    }
    ...
    enum OneOf_Kind: Equatable, Sendable {
      ...
      case worldEvent(Symbolic_Pb_WorldEvent)
...
extension Symbolic_Pb_PathEvent.Kind: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    202: .same(proto: "move"),
    301: .standard(proto: "set_node_type"),
    302: .standard(proto: "set_segment_type"),
  ]
...
extension Symbolic_Pb_ItemEvent.SetName: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Symbolic_Pb_ItemEvent.protoMessageName + ".SetName"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "name"),
  ]
  ...
  static func ==(lhs: Symbolic_Pb_ItemEvent.SetName, rhs: Symbolic_Pb_ItemEvent.SetName) -> Bool {
...
extension Symbolic_Pb_ItemEvent.SetLocked: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Symbolic_Pb_ItemEvent.protoMessageName + ".SetLocked"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "locked"),
  ]
  ...
  static func ==(lhs: Symbolic_Pb_ItemEvent.SetLocked, rhs: Symbolic_Pb_ItemEvent.SetLocked) -> Bool {
...
extension Symbolic_Pb_ItemEvent.Kind: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Symbolic_Pb_ItemEvent.protoMessageName + ".Kind"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 201: try {
        var v: Symbolic_Pb_ItemEvent.SetName?
        var hadOneofValue = false
        if let current = self.kind {
          hadOneofValue = true
      ...
      case 202: try {
        var v: Symbolic_Pb_ItemEvent.SetLocked?
        var hadOneofValue = false
        if let current = self.kind {
          hadOneofValue = true
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    switch self.kind {
    case .setGroup?: try {
      guard case .setGroup(let v)? = self.kind else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 101)
    }()
    case .setName?: try {
  ...
  static func ==(lhs: Symbolic_Pb_ItemEvent.Kind, rhs: Symbolic_Pb_ItemEvent.Kind) -> Bool {
    if lhs.kind != rhs.kind {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Symbolic_Pb_WorldEvent: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = _protobuf_package + ".WorldEvent"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      switch fieldNumber {
      case 101: try {
        var v: Symbolic_Pb_WorldEvent.SetSymbolIds?
        var hadOneofValue = false
        if let current = self.kind {
          hadOneofValue = true
      ...
      case 102: try {
        var v: Symbolic_Pb_WorldEvent.SetGrid?
        var hadOneofValue = false
        if let current = self.kind {
          hadOneofValue = true
          if case .setGrid(let m) = current {v = m}
  ...
  static func ==(lhs: Symbolic_Pb_WorldEvent, rhs: Symbolic_Pb_WorldEvent) -> Bool {
    if lhs.kind != rhs.kind {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Symbolic_Pb_WorldEvent.SetSymbolIds: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Symbolic_Pb_WorldEvent.protoMessageName + ".SetSymbolIds"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "symbol_ids"),
  ]
  ...
  static func ==(lhs: Symbolic_Pb_WorldEvent.SetSymbolIds, rhs: Symbolic_Pb_WorldEvent.SetSymbolIds) -> Bool {
    if lhs.symbolIds != rhs.symbolIds {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Symbolic_Pb_WorldEvent.SetGrid: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  static let protoMessageName: String = Symbolic_Pb_WorldEvent.protoMessageName + ".SetGrid"
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .same(proto: "grid"),
  ]
  ...
  static func ==(lhs: Symbolic_Pb_WorldEvent.SetGrid, rhs: Symbolic_Pb_WorldEvent.SetGrid) -> Bool {
    if lhs._grid != rhs._grid {return false}
    if lhs.unknownFields != rhs.unknownFields {return false}
    return true
  }
...
extension Symbolic_Pb_DocumentEvent.Single: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    104: .standard(proto: "world_event"),
  ]
  ...
  mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 104: try {
        var v: Symbolic_Pb_WorldEvent?
        var hadOneofValue = false
        if let current = self.kind {
          hadOneofValue = true
          if case .worldEvent(let m) = current {v = m}
        }
        try decoder.decodeSingularMessageField(value: &v)
        if let v = v {
          if hadOneofValue {try decoder.handleConflictingOneOf()}
          self.kind = .worldEvent(v)
        }
      }()
      default: break
      }
  ...
  func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    case .worldEvent?: try {
      guard case .worldEvent(let v)? = self.kind else { preconditionFailure() }
      try visitor.visitSingularMessageField(value: v, fieldNumber: 104)
    }()
    case nil: break
    }
